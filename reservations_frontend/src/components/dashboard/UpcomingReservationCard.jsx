...
const UpcomingReservationCard = ({
  ...
  return (
    <section
      ...
      className="bg-[#2C3E36]/40 backdrop-blur-xl border border-[#81A68D]/30 rounded-2xl shadow-xl p-8 overflow-hidden relative"
    >
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <h2
              ...
              className="text-2xl font-light text-[#2C3E36] mb-2"
            >
      ...
      <ul className="relative z-10 mt-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        <li>
          <article className="backdrop-blur-sm bg-[#D9D4C8]/40 rounded-xl p-4 border border-[#D9D4C8]/30">
        ...
        <li>
          <article className="backdrop-blur-sm bg-[#D9D4C8]/40 rounded-xl p-4 border border-[#D9D4C8]/30 flex items-center justify-center">
            <span
